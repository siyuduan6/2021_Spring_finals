...
df_2015.groupby('date').size().sort_values(ascending=False)


# In[55]:


df_2016.groupby('date').size().sort_values(ascending=False).head(10)


# In[52]:


df_2017.groupby('date').size().sort_values(ascending=False)
